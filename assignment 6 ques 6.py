...
student_data(student_id="22103004")
student_data(student_id="22103004", student_name="Gursartaj Singh Grewal")
student_data(student_id="22103004", student_name="Gursartaj Singh Grewal", student_class="1st Year")
